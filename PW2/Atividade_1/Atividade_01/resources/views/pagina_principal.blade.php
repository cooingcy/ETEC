...
<head>
    ...
    <title>ETEC DA ZONA LESTE - Página principal</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav">
        <a class="nav-link active" aria-current="page"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home">
...
<div class="imagem-textos-container">
    <div class="imagem-fundo">
        <div class="textos container mt-5">
            <h1>Bem-vindo à ETEC DA ZONA LESTE</h1>
            <h2 class="mt-3">Sua jornada educacional começa aqui.</h2>
        </div>
    </div>
    <div class="button-container">
    <a href="http://localhost:8000/quem_somos" class="btn btn-light" id="custom-button">Nossa História</button>
    </div>
</div>
